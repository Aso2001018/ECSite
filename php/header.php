...
<header>
  <div class="top_line">
    ...
    <form action="search.php"method="post" class="glass">
...
?>
    ...
    <ul class="nav_menu3">
      <form method="post" action="search.php">
        <button name="s_type" value="2" class="nav_menu3_item" type="submit">デスクトップPC</button>
        <button name="s_type" value="3" class="nav_menu3_item" type="submit">ノートPC</button>
        <button name="s_type" value="1" class="nav_menu3_item" type="submit">ゲーミングPC</button>
        <button name="s_type" value="4" class="nav_menu3_item" type="submit">クリエイター向けPC</button>
      </form>
    </ul>
  </nav>
</header>
