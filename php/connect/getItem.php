...
function setItemData($href,$img,$name,$html,$price,$isfav,$item,$os,$cpu,$ram,$gpu,$ssd,$hdd,$idn,$iscart,$cart=-1) {
  echo'
  <hr>
  <div class="item">
    <div class="item_img">
    ...
    <div class="item_noimage">
      ...
      <div class="item_button">
        ...
        <button type="button"id="cart_button_',$idn,'"class="button_',$iscart?'delete':'addcart','">カート',$iscart?'から削除':'へ追加','</button>
        <input type="checkbox"class="check_favorite"id="check_favorite_',$item,'"',$isfav?'checked':'','>
        <label class="button_favorite"id="button_favorite_',$idn,'"for="check_favorite_',$item,'"',$_SESSION['login']&&!$iscart?'':'style="display:none"','>
